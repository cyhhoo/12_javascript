...
// NaN은 어떠한 비교 연산자를 이용해 비교가 불가능 하다
...
// console.log(+Symbol()); // NaN TypeError: Cannot convert a Symbol value to a number

console.log(+{}); // 객체, NaN
console.log(+[]); // 배열. 0 (빈 배열)
console.log(+[999]); // 배열, 999 (0번 인덱스 값을 숫자로 변환)
console.log(+['a']); // 배열, NaN (0번 인덱스 값을 숫자로 변환)
console.log(+[999,888]); // 배열, NaN (여러 인덱스가 있어 무엇을 숫자로 변환할 지 모름)
